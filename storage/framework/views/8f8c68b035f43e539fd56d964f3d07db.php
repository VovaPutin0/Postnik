...
<style>
    ...
    .bgContent {
        background-image: url('<?php echo e(asset('img/bgContent.png')); ?>');
        background-repeat: no-repeat;
        background-size: cover;
    }

    .bgFood {
        background-image: url('<?php echo e(asset('img/bgFood.png')); ?>');
        background-repeat: no-repeat;
        background-size: cover;
    }
</style>
<?php $__env->startSection('content'); ?>
    ...
    <section class="container">
        ...
        <div class="bgPlan">
            <div class="block">
                <img class="planImg" src="<?php echo e(asset('img/img.png')); ?>" alt="">
                <ul class="spisok">
...
<?php echo $__env->make('layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/Postnik/resources/views/index.blade.php ENDPATH**/ ?>